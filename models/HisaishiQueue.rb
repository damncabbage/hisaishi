  ...
  def self.predefined_queues
    {
      "single_heat" => [
        ...
        {:song_id => 651, :requester => 'Xena'}, 
        {:song_id => 609, :requester => 'Vivienne'}, 
        {:song_id => 541, :requester => 'Mel'}, 
      ...
      "duet_heat" => [
        ...
        {:song_id => 315, :requester => 'Belinda Yuqi Ding n Michael Chan'}, 
        {:song_id => 292, :requester => 'Annie Lam n Mai Uchino'}, 
        {:song_id => 628, :requester => 'Tranh Tran Thein Le n Vi Tuong Nguyen'},
        {:song_id => 629, :requester => 'Derrasanc n Genn'},
      ],
      "single_final" => [
        {:song_id => 630, :requester => 'Shanee Conran'}, 
        {:song_id => 631, :requester => 'Clarissa Lin'}, 
        {:song_id => 621, :requester => 'Corina Alexe (aka Corinne Procycon)'}, 
        {:song_id => 632, :requester => 'Susan'}, 
        {:song_id => 633, :requester => 'Phoebe Sim'}, 
        {:song_id => 634, :requester => 'Alex Ngai'}, 
        {:song_id => 635, :requester => 'Chantel Simeoni'}, 
        {:song_id => 636, :requester => 'Lynneal Santos (nime)'}, 
        {:song_id => 637, :requester => 'Xena'}, 
        {:song_id => 638, :requester => 'Vivienne'}, 
        {:song_id => 546, :requester => 'Mel'}, 
        {:song_id => 650, :requester => 'Gabriel Seah Hian Ong'},
        {:song_id => 639, :requester => 'Jane Soo'}, 
        {:song_id => 640, :requester => 'Belinda Yuqi Ding'}, 
        {:song_id => 641, :requester => 'Jennifer Akitsuki'}, 
        {:song_id => 383, :requester => 'Aarti Mahajan'}, 
        {:song_id => 642, :requester => 'Mai Uchino'}, 
        {:song_id => 134, :requester => 'Nadya Shturman'}, 
        {:song_id => 524, :requester => 'Karen Algeo'}, 
        {:song_id => 616, :requester => 'Kaylee Chidgey'}, 
        {:song_id => 617, :requester => 'Sophia Kim'}, 
        {:song_id => 643, :requester => 'Crystal Bai'}, 
        {:song_id => 524, :requester => 'Annie Lam'}, 
        {:song_id => 644, :requester => 'Ben Pushka'}, 
        {:song_id => 645, :requester => 'Yasemin'}, 
      ],
      "duet_final" => [
        {:song_id => 156, :requester => 'Emily Shen'}, 
        {:song_id => 646, :requester => 'Corina Alexe (aka Corinne Procycon) n Minh Procycon'}, 
        {:song_id => 622, :requester => 'Andrea n Brenda Lo'}, 
        {:song_id => 640, :requester => 'Elizabeth n Soo Yeun Melissa Lim'}, 
        {:song_id => 647, :requester => 'Justine Jiang n Susan Lee'}, 
        {:song_id => 156, :requester => 'Gabriel n Lisa'},         
        {:song_id => 626, :requester => 'Emi Stuart n Mari Stuart'}, 
        {:song_id => 648, :requester => 'Belinda Yuqi Ding n Michael Chan'}, 
        {:song_id => 292, :requester => 'Annie Lam n Mai Uchino'}, 
        {:song_id => 628, :requester => 'Tranh Tran Thein Le n Vi Tuong Nguyen'},
        {:song_id => 649, :requester => 'Derrasanc n Genn'},
      ]
    }
  end
